...
const { getProfile, updateProfile, saveDraft, submitProfile, uploadImages, getGroups, getGroupById, approveGroup, rejectGroup } = require('../controllers/mahilaGroupController');
